...
def _handle_hooks(mw: aqt.main.AnkiQt, ankihaptics_ref, hook: str) -> None:  # noqa: ANN001
...
def _answer_button_press(mw: aqt.main.AnkiQt, ankihaptics_ref, _reviewer: aqt.reviewer.Reviewer, _card: anki.cards.Card, ease: int) -> None:  # noqa: ANN001
    button_name = ease_to_button[ease]
    _handle_hooks(mw, ankihaptics_ref, button_name)

def _show_question(mw: aqt.main.AnkiQt, ankihaptics_ref, _card: anki.cards.Card) -> None:  # noqa: ANN001
    _handle_hooks(mw, ankihaptics_ref, "show_question")

def _show_answer(mw: aqt.main.AnkiQt, ankihaptics_ref, _card: anki.cards.Card) -> None:  # noqa: ANN001
